      ...
      <article className="create-container">
        <header style={{  backgroundImage: `url(${creator.imageURL})`, height: "700px", backgroundSize: "cover", backgroundPosition: "center", padding: "3rem 2rem",marginBottom: "1.5rem"}}>
          ...
          <div className="view-socials">
            {creator.instagram ? <SocialIcon network="instagram" url={creator.instagram} /> : null}
            {creator.x ? <SocialIcon network="x" url={creator.x} /> : null}
            {creator.linkedin ? <SocialIcon network="linkedin" url={creator.linkedin} />: null}
            {creator.youtube ? <SocialIcon network="youtube" url={creator.youtube} />: null}
          </div>
        </header>
